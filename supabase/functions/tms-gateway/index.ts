...
const ALLOW: RegExp[] = [
  ...
  /* ใบของเที่ยวหนึ่งพร้อมรายการสินค้า — เส้น search ส่ง pickingLists มาแบบไม่มี details
     จำนวนต่อรุ่นจึงหายทั้งระบบ ต้องถามเส้นนี้ทีละเที่ยวถึงจะได้มา (body: { Id }) */
  /^\/v1\/tripheaders\/pickingList$/,
]
