-- ส่งเลขใบ PL ออกมาให้หน้า "เที่ยวจาก TMS" เห็น
--
-- เดิมส่งมาแค่จำนวนใบ คนวางแผนจึงเห็น "12 ใบ" แล้วต้องเปิด TMS อีกจอ
-- เพื่อจะรู้ว่าใบไหนบ้าง ทั้งที่เลขใบอยู่ใน tms_shipments ครบอยู่แล้ว
