-- เพิ่ม "จุดสูงสุด/เที่ยว" ต่อคัน + รายละเอียดทุกเที่ยว (trip_rows) ให้หน้ารายงาน
-- ป้องกันเข้าใจผิดว่าเบี้ยคิดจากยอดจุดรวมทั้งช่วง ทั้งที่จริงคิดจากจุดสูงสุดในเที่ยวเดียว
...
begin
  ...
  veh as (
    select ts.vehicle_id,
           ...
           /* จุดสูงสุดในเที่ยวเดียวของคันนี้ — ตัวเลขนี้บอกได้ตรง ๆ ว่ามีเที่ยวไหน
              แตะเกณฑ์เบี้ยบ้าง โดยไม่ต้องไปไล่ดูทีละเที่ยว (แก้ปัญหาเข้าใจผิดที่เจอจริง
              18 ก.ย. 69 — คนอ่านนึกว่าเบี้ยคิดจากยอดจุดรวมทั้งช่วง) */
  ...
  select jsonb_build_object(
    ...
    /* รายละเอียดทุกเที่ยว — ให้เห็นจุดส่ง/เบี้ยเป็นรายเที่ยวจริง ๆ เฉพาะคนมีสิทธิ์เงิน
       เพราะมีค่าขนส่งอยู่ในแถวเดียวกัน (กติกาเดิม: ตัวเลขเงินเห็นได้เฉพาะ dispatch.view) */
