-- วันเริ่มต้นของหน้า "เที่ยวจาก TMS" ให้เป็นวันนี้ก่อน
--
-- รอบอัตโนมัติในหน้าดึงข้อมูลถูกปรับให้ดึงเฉพาะเที่ยวของวันนี้ (pullRecentTrips)
-- แต่ preview ยังเลือก "วันล่าสุดที่มีเที่ยวพร้อมนำเข้า" ซึ่งเป็นเมื่อวานได้
-- ถ้าของเมื่อวานยังไม่ถูกเคลียร์ — เปิดหน้ามาเลยเจอวันที่ผิด
-- ลำดับใหม่: วันนี้ (ถ้ามีงานที่ทำได้) > วันล่าสุดที่มีงานที่ทำได้ > วันล่าสุดที่มีข้อมูล
