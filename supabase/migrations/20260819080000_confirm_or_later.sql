-- Confirm คือ "ผ่านมาแล้ว" ไม่ใช่ "ตอนนี้ต้องเป็น"
--
-- ประตูนำเข้าที่ใส่ไว้รอบก่อนเทียบสถานะเท่ากับ 'confirm' ตรง ๆ แต่ TMS เดินสถานะต่อ
-- เป็น OnDelivery แล้ว Completed เที่ยวที่ยืนยันแผนไปแล้วและเริ่มวิ่งจึงถูกปฏิเสธตลอดกาล
-- ทั้งที่ผ่านเงื่อนไขที่ประตูนี้ต้องการมาตั้งนานแล้ว ผลคือยิ่งคนวางแผนมาสั่งงานช้า
-- ยิ่งสั่งไม่ได้ ซึ่งตรงข้ามกับที่ตั้งใจไว้
--
-- สิ่งที่ต้องกันจริง ๆ คือสถานะ "ก่อน Confirm" (แผนที่ยังเปลี่ยนได้) ส่วนเที่ยวที่ถูกยกเลิก
-- มีด่านของตัวเองอยู่แล้ว (status_id = 6)
