-- นำเข้าเที่ยวแล้วเก็บรายการของกับค่าขนส่งไว้ด้วย
--
-- เดิม import_tms_trip ทิ้งข้อมูลสองชุดที่ดูดมาแล้ว:
--  * รหัสสินค้ากับจำนวนต่อรายการ ถูกยุบเป็นข้อความเดียวใน orders.goods_desc
--  * ค่าจ้างขนส่งจาก TMS ไม่ถูกคัดลอกมาที่ trips เลย
-- ตารางกับคอลัมน์รองรับถูกสร้างไว้แล้วใน 20260818070000
