-- นำเข้าเที่ยวก็ต้องเทียบทะเบียนด้วยกุญแจเหมือน create_vehicle_from_tms
--
-- import_tms_trip มีเส้นทางหารถของตัวเองแยกต่างหาก และยังเทียบ plate_no แบบข้อความตรง
-- ซึ่งเป็นต้นเหตุเดียวกับที่ทำให้เกิดรถซ้ำ — แก้ที่ create_vehicle_from_tms ที่เดียวไม่พอ
