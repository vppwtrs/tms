 ...
 *
 *  เคยลองเปิดเป็นทุกคลังแล้วถอยกลับ: บัญชีคนวางแผนเห็น 6 คลัง ซึ่งรวมของแผนกอื่น
 *  ที่ไม่ใช่งานของระบบนี้ ด่าน carrier กันของผู้รับจ้างรายอื่นได้ก็จริง แต่กันงาน
 *  ของกองรถเราที่คลังอื่นดูแลเองไม่ได้ ขอบเขตคลังจึงเป็นเรื่องที่คนกำหนด ไม่ใช่เดาจากสิทธิ์
 *
