...
export type TmsOp =
  ...
  | 'trips'
  | 'tripPickingList'
  /** ค้นใบเดียวด้วยเลขใบ — ใช้เติมรายการสินค้าของใบที่ไล่ตามช่วงวันไม่เจอ */
  | 'pickingListByNo'
  | 'scanPickingListsByNo'
  /** รายงานยอดส่งจริงของช่วงวัน — ใช้ที่หน้ารายงานอย่างเดียว ไม่ได้เข้าฐานเรา */
  | 'actualShipment'
  /** รายงานแผนจำลองของช่วงวัน — อ่านอย่างเดียวเหมือนกัน */
  | 'planSimulate'
