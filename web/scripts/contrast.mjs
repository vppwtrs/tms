...
// เลขลำดับจุดส่งของคนขับ — พื้นทึบ ตัวอักษรเป็นสีพื้นหลังของธีม
pass.push(row('surface on stop-seq active (info)', '#ffffff', '#4e5fc7'))
pass.push(row('surface on stop-seq done (ok)', '#ffffff', '#1f7a5f'))
pass.push(row('surface on driver tab badge (danger)', '#ffffff', '#b8405b'))
...
pass.push(row('surface on stop-seq active (dark, info)', '#1c1830', '#93a0f2'))
pass.push(row('surface on stop-seq done (dark, ok)', '#1c1830', '#4cbf9c'))
pass.push(row('surface on driver tab badge (dark, danger)', '#1c1830', '#ee8098'))
